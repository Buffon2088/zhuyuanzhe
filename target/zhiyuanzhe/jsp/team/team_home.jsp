      ...
      <div class="container">
        <div class="section-content">
          <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <form class="form" action="#">
                    <table class="table table-bordered">
                      ...
                      <tr>
                        <td><input type="date" class="form-control" placeholder="开始时间" value=""></td>
                      </tr>
                      <tr>
                        <td><input type="date" class="form-control" placeholder="结束时间" value=""></td>
                      </tr>
                      <tr>
                        <td><button type="button" class="cart-update-total-button btn btn-theme-colored1">筛选</button>
                          <button type="button" class="-cart-update-btn btn btn-theme-colored2">退出该组织</button></td>
                        </td>
                      </tr>
                      </tbody>
                    </table>
                ...
                <div class="col-md-6">
                  ...
                  <table class="table table-bordered">
                    ...
                    <tr>
                      <td>标志</td>
                      <td style="color: red;">
                        <img src="${pageContext.request.contextPath}/img/${teamInfo.img}" style="width: 70px;height: 70px;">
                      </td>
                    </tr>
                    <tr>
                      <td>创始人</td>
                      <td style="color: red;">${teamInfo.userInfo.userName}</td>
                    </tr>
                    <tr>
                      <td>成立时间</td>
                      <td>${teamInfo.teamState}</td>
                    </tr>
                    <tr>
                      <td>服务时长</td>
                      <td style="color: green">${teamInfo.teamHelpTime}/h</td>
                    </tr>
                    <tr>
                      <td>等级</td>
                      <td style="color: red">${teamInfo.teamTypeInfo.teamTypeName}</td>
                    </tr>
                    <tr>
                      <td>当前人数</td>
                      <td style="color: red">${teamInfo.teamNowNum}/人</td>
                    </tr>
                    <tr>
                      <td>我的职位</td>
                      <td style="color: red">${teamInfo.userInfo.teamJobInfo.teamJobName}
                        <button type="button" class="cart-update-total-button btn btn-theme-colored1" style="float: right">报名活动</button>
                      </td>
                    </tr>
                    </tbody>
                  </table>
            ...
            <div class="col-md-12">
              <h3 style="text-align: center">-组织信息-</h3>
                ...
                <table class="table table-striped table-bordered tbl-shopping-cart">
                  ...
                  <tbody>
                    <tr class="cart_item">
                      ...
                      <td class="product-thumbnail"><a href="#"><img alt="product" src="images/shop/product.jpg"></a></td>
                      ...
                      <td class="product-quantity">无</td>
                      <td class="product-subtotal"><button type="button" class="cart-update-total-button btn btn-theme-colored1">查看</button></td>
                    </tr>
                    <tr class="cart_item">
                      <td colspan="3">
