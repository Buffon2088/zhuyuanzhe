...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="${pageContext.request.contextPath}/js/revolution-slider/extra-rev-slider1.css">
                    ...
                    <div class="col-xl-auto header-top-left align-self-center text-center text-xl-left">
                        <ul class="element contact-info">
                            ...
                            <li class="contact-email"><i
                                    class="fa fa-envelope font-icon sm-display-block"></i> ${sessionScope.userInfo.userEmail}
                            </li>
                            <li class="contact-address"><i
                                    class="fa fa-map font-icon sm-display-block"></i> ${sessionScope.userInfo.userCardId}
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <ul id="main-nav" class="menuzord-menu">
                                        ...
                                        <li class="menu-item"><a href="page-causes-grid.html">组织模块</a>
                                            <ul class="dropdown">
                                                ...
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/Team/findTeam?userId=${sessionScope.userInfo.userId}">加入组织</a>
                                                </li>
                                                <li>
                                                    <a href="${pageContext.request.contextPath}/Team/MyTeam?userId=${sessionScope.userInfo.userId}">我的组织</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="menu-item"><a href=${pageContext.request.contextPath}/User/userIndex>个人中心
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                                                ...
                                                <div class="top-nav-mini-cart-icon-contents">
                                                    <a class="mini-cart-icon" href="shop-cart.html"
                                                       title="View your shopping cart">
                                                        ...
                                                        <span class="cart-quick-info">1 item - <span
                                                                class="amount"><span
                                                    ...
                                                    <div class="dropdown-content">
                                                        ...
                                                        <p class="total"><strong>当前状态：</strong> <span
                                                                ...
                                                                class="currencySymbol"></span><font
                                                                style="color: #045e04;">在线</font></span></p>
...
<%--模糊查询/输入框搜索--%>
<script>
    function  searchView(date){
        var date=document.getElementById('coupon_code').innerText;
        $.ajax({
            url : '${pageContext.request.contextPath}/Team/reqTeamSave',
            method: 'post',
            data: {'date': date},
