...
<div style="padding-top: 100px;text-align: center;">
    <table>
        ...
        <div style="text-align: center;padding-top: 20px;">
            ...
            查询申请: <input type="text" style="width: 200px;"><button>搜索</button>
            <thead>
            <tr>
                <td>申请人</td>
                <td>照片</td>
            ...
            <c:forEach items="${activeJoinInInfoList}" var="nl">
                ...
                <tr>
                    ...
                    <td> <img src="${pageContext.request.contextPath}/img/${nl.userInfo.img}" style="width: 50px;height:50px"></td>
                    ...
                    <c:choose>
                        <c:when test="${nl.activeJoinInState=='已通过'}">
                            <td>
                                <a href="#" style="color: darkgreen">已通过</a>
                                <a href="#" style="color: darkgreen">发送邮件提醒</a>
                            </td>
                        </c:when>
                        <c:when test="${nl.activeJoinInState=='已拒绝'}">
                            <td>
                                <a href="#" style="color: red">已拒绝</a>
                                <a href="#" style="color:red">发送邮件提醒</a>
                            </td>
                        </c:when>
                        <c:when test="${nl.activeJoinInState=='申请中'}">
                            <td>
                                <a href="${pageContext.request.contextPath}/admin/ActRequestResult?activeJoinInId=${nl.activeJoinInId}&updateState=0" style="color: darkgreen">同意</a>
                                <a href="${pageContext.request.contextPath}/admin/ActRequestResult?activeJoinInId=${nl.activeJoinInId}&updateState=1" style="color: red">拒绝</a>
                            </td>
                        </c:when>
                    </c:choose>
                </tr><br>
